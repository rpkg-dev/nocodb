...
#' `PATCH /api/v1/user/profile` API endpoint.
#'
#' @inheritParams api
...
#'
#' This API endpoint does not support authentication via [API tokens](https://docs.nocodb.com/account-settings/api-tokens/).
#'
#' @inheritParams api
