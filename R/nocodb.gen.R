...
#'
#' @inheritParams base
#' @param include_m2m Whether or not to include many-to-many junction tables in the result.
#'
#' @return `r pkgsnip::return_lbl("tibble")`
#' @family tbls
#' @export
...
#' @param connection Subtype-specific connection details for database integrations. A list.
#' @param search_paths Database search paths (schemas) to expose for the `"pg"` integration. A character vector.
#'
